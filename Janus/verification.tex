...
\begin{figure}[H]
  \centering
  \subfloat[Rectangular cells]{\includegraphics[width=0.5\textwidth]
  {./Janus/quad_diff}\label{quad_diff}}
  \subfloat[Quadrilateral cells]{\includegraphics[width=0.5\textwidth]
...
Level Symmetric quadrature and the $S_8$ Gauss-Legendre-Chebyshev quadrature.
\begin{figure}[H]
  \centering
  \subfloat[LS quadrature]{\includegraphics[width=0.5\textwidth]
  {./Janus/ls_conv_pwld}\label{ls_pwld}}
  \subfloat[GLC quadrature]{\includegraphics[width=0.5\textwidth]
